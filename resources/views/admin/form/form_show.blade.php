      ...
      <div class="card-body">
        <div class="col-md-12" align="center">
          ...
          <img src="{{ asset('/images/'.$passport->passport_img) }}" style="height: 150px; width: 150px" class="img-fluid">
            <a href="{{ route('edit.passport', ['id' => $passport->id]) }}" class="btn btn-link text-warning"> Edit 
            </a>
            @endforeach
            <br>
        </div>   
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><div class="col-md-3">
                                  <h4 align="right"><a href="{{ route('edit.secondary', ['id' => $secondary->id]) }}" class="btn btn-link text-warning">Edit </a></h4>
                                </div>
                            </td>                 
                          </tr>
                        </tbody>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><a href="{{ route('edit.secondaire', ['id' => $secondaire->id]) }}" class="btn btn-link text-warning">Edit</a> </td>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><b>Sur:</b> <?php echo $balance = DB::table('secondaires')->where('unique_id', $secondaire->unique_id)->sum('sur'); ?></td>
                            <td></td>
                      ...
                      <table class="table-bordered">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><div class="col-md-3">
                                  <h4 align="right"><a href="{{ route('edit.university', ['id' => $university->id]) }}" class="btn btn-link text-warning">Edit </a></h4>
                                </div></td>
                          </tr>
                        </tbody>
                        @endforeach
        ...
        <div class="col-md-12">
          <div class="card">
                ...
                <div class="col-md-12">
                    <div class="card">
                            <div class="card-body">
                              <strong><h4> Secondary Degree</h4> </strong>
                              <div class="card">                              
                                <div class="col-md-12">
                                <div class="card-body my-3">
